...
#[no_mangle]
pub extern "system" fn Java_rs_ove_crypt_proto_NativeMst5_nativeUploadE2EWithKey(
    mut env: JNIEnv<'_>,
    _class: JClass<'_>,
    endpoint: JString<'_>,
    public_key: JString<'_>,
    ...
    plaintext_size: jlong,
    fd: jint,
    media_key: JByteArray<'_>,
    file_aad: JByteArray<'_>,
    observer: JObject<'_>,
) -> jboolean {
    let result = (|| -> Result<(), String> {
        if plaintext_size < 0 || fd < 0 {
        ...
        let media_key: [u8; 32] = java_bytes(&mut env, media_key)?
            .try_into()
            .map_err(|_| "E2E media key must be 32 bytes".to_string())?;
        let file_aad = java_bytes(&mut env, file_aad)?;
        let (endpoint, public_key, ticket, file_id) =
            transfer_strings(&mut env, endpoint, public_key, ticket, file_id)?;
        let progress = JavaProgress::new(&mut env, observer, plaintext_size as u64)?;
        let file = duplicate_file(fd)?;
...
#[no_mangle]
pub extern "system" fn Java_rs_ove_crypt_proto_NativeMst5_nativeDownloadE2EWithKey(
    mut env: JNIEnv<'_>,
    _class: JClass<'_>,
    endpoint: JString<'_>,
    public_key: JString<'_>,
...
#[no_mangle]
pub extern "system" fn Java_rs_ove_crypt_proto_NativeMst5_nativeDownloadE2EBytesWithKey(
    mut env: JNIEnv<'_>,
    _class: JClass<'_>,
    endpoint: JString<'_>,
    public_key: JString<'_>,
...
#[no_mangle]
pub extern "system" fn Java_rs_ove_crypt_proto_NativeMst5_nativeE2EMediaKey(
    mut env: JNIEnv<'_>,
    _class: JClass<'_>,
    handle: jlong,
    peer: JByteArray<'_>,
